...
def userlogin():
	...
	userdic = {'niejikai':'niejikai','jiangzikun':'jiangzikun','fupingmei':'fupingmei',
	'111':'111'}
...
def mainpage():
	...
	def Adaptive_Boosting():
		...
		Label(AB_frame,text = '这是AB的界面').pack()
		FR = AB_frame        
	...
	def Update_Log():
		...
		'\n ▪ 新增了版本号的同步规则\n ▪ 新增了详细报错信息\n ▪ 调整了菜单栏结构'
		UL_frame_text6 = ' TAS-test-v0.4.7（Text Anatomy Software）\n 24 August 2019'\
		'\n ▪ 新增“Gradient Boosting Decision Tree”功能\n ▪ 新增“eXtreme Gradient Boosting”功能\n'\
		' ▪ 新增“Random Forest”功能'
		
		UL_frame_text = UL_frame_text6 + UL_frame_text5 + UL_frame_text4 + \
						UL_frame_text3 + UL_frame_text2 + UL_frame_text1 + \
						UL_frame_text0
